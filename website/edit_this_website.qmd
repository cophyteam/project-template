...
6. Add, commit and push to the main branch. 

7 Type `cd website` and `quarto publish gh-pages`. This should automatically trigger and update of the [website](https://cophyteam.github.io/project-template) after a few minutes (you can check the deployment process [here](https://github.com/cophyteam/project-template/actions))
